...
`}function h(e){return e.map(f).join("")}function t(e,i){e.innerHTML=i}const l={message:"Common message",theme:"dark",position:"topRight",titleColor:"#fff",titleSize:"16px",titleLineHeight:"1.5",messageColor:"#fff",messageSize:"16px",messageLineHeight:"1.5",imageWidth:24},u={...l,color:"#ef4040",iconUrl:"error-icon.svg"},y={...l,title:"Warning",color:"#ffa000",iconUrl:"caution-icon.svg"},d='<li class="load-message">Loading images, please wait...</li>',r=document.querySelector(".gallery"),w=document.querySelector(".search-button"),s=document.querySelector(".search-input"),v=new g(".gallery a",{captionsData:"alt",captionDelay:250,overlayOpacity:.8});w.addEventListener("click",k);function k(e){e.preventDefault();let i=String(s.value.trim());i=i.replace(/[*]/g,"");let o="";if(!i||i.length<3){n.warning({...y,message:"Enter data for search, please. Min. 3 symbols."}),s.value="",t(r,"");return}console.log(`fetch data from backend with search term: ${i}`),t(r,d),p(i).then(a=>{a.hits.length===0?(n.error({...u,message:"Sorry, there are no images matching<br> your search query. Please, try again!"}),s.value="",t(r,"")):(s.value="",o=h(a.hits),t(r,o),v.refresh())}).catch(a=>{console.error("сталося щось дивне",a)})}window.onerror=(e,i,o,a,c)=>{console.error("Unhandled error:",c)};
